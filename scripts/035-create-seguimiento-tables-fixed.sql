-- Crear tabla de seguimiento de casos si no existe
...
-- Crear tabla de comentarios de seguimiento si no existe
...
CREATE INDEX IF NOT EXISTS idx_seguimiento_casos_created_at ON seguimiento_casos(created_at);
CREATE INDEX IF NOT EXISTS idx_seguimiento_comentarios_caso_id ON seguimiento_comentarios(caso_id);
CREATE INDEX IF NOT EXISTS idx_seguimiento_comentarios_created_at ON seguimiento_comentarios(created_at);
...
DROP TRIGGER IF EXISTS update_seguimiento_casos_updated_at ON seguimiento_casos;
